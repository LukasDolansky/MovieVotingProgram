...
async function getList(req, res, next) {
    ...
    if(category == undefined && year == undefined && isWinner == undefined) {
      console.log("GET request with no parameters specified, redirecting to home...");
      res.redirect('/home');
      return;
    }
...
module.exports = results;        //Export this file as a module so it can be called elsewhere